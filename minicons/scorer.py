...
class LMScorer:
    ...
    def __init__(self, model_name: str, device: Optional[str] = "cpu", use_auth_token=False) -> None:
        """
        ...
        """
        self.tokenizer = AutoTokenizer.from_pretrained(model_name, use_fast=True, use_auth_token=use_auth_token)
        self.device = device
...
class MaskedLMScorer(LMScorer):
    ...
    def __init__(self, model_name: str, device: Optional[str] = "cpu", use_auth_token=False, **kwargs) -> None:
        """
        :param model_name: name of the model, should either be a path
            to a model (.pt or .bin file) stored locally, or a
            pretrained model stored on the Huggingface Model Hub.
        ...
        self.model = AutoModelForMaskedLM.from_pretrained(model_name, return_dict=True, use_auth_token=use_auth_token, **kwargs)
...
class IncrementalLMScorer(LMScorer):
    ...
    def __init__(self, model_name: str, device: Optional[str] = "cpu", use_auth_token=False, **kwargs) -> None:
        ...
        self.model = AutoModelForCausalLM.from_pretrained(model_name, return_dict=True, use_auth_token=use_auth_token, **kwargs)
...
class Seq2SeqScorer(LMScorer):
    ...
    def __init__(self, model_name: str, device: Optional[str] = "cpu", use_auth_token=False, **kwargs) -> None:
        ...
        self.model = AutoModelForSeq2SeqLM.from_pretrained(model_name, return_dict=True, use_auth_token=use_auth_token, **kwargs)
