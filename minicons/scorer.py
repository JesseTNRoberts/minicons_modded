...
class MaskedLMScorer(LMScorer):
    ...
    def __init__(self, model_name: str, device: Optional[str] = "cpu", token=None, **kwargs) -> None:
        ...
        :type device: str, optional
        """
        super(MaskedLMScorer, self).__init__(model_name, device, token=token)
...
class IncrementalLMScorer(LMScorer):
    ...
    def __init__(self, model_name: str, device: Optional[str] = "cpu", token=None, **kwargs) -> None:
        ...
        :type device: str, optional
        """
        super(IncrementalLMScorer, self).__init__(model_name, device, token=token)
...
class Seq2SeqScorer(LMScorer):
    ...
    def __init__(self, model_name: str, device: Optional[str] = "cpu", token=None, **kwargs) -> None:
        ...
        :type device: str, optional
        """
        super(Seq2SeqScorer, self).__init__(model_name, device, token=token)
